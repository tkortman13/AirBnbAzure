...
workspace_name = "AzureSPUProject" # PLACEHOLDER
subscription_id = "58cd0ee3-7300-4ead-ad5d-cb08a52b57d3" # PLACEHOLDER
resource_group = "spugraduateISM" # PLACEHOLDER
experiment_name = "SPUProject" # PLACEHOLDER
iteration = "23"  # PLACEHOLDER
run_id = "AutoML_18b69708-aad0-4473-b0c1-fccb90933563_23"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'kortmant1','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':120,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':120,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'SPUProject','path':'./sample_projects/SPUProject','primary_metric':'r2_score','region':'eastus2','resource_group':'spugraduateISM','subscription_id':'58cd0ee3-7300-4ead-ad5d-cb08a52b57d3','task_type':'regression','validation_size':None,'test_size':0.3,'vm_type':'STANDARD_D4S_V3','workspace_name':'AzureSPUProject','label_column_name':'price','save_mlflow':True,'enable_batch_run':True,'dataset_id':'92986d2f-eeae-4f46-b541-458200de3c32'} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"SparseNormalizer\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"norm\": \"l2\"}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"XGBoostRegressor\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"booster\": \"gbtree\", \"colsample_bytree\": 0.7, \"eta\": 0.2, \"gamma\": 0, \"max_depth\": 6, \"max_leaves\": 0, \"n_estimators\": 200, \"objective\": \"reg:linear\", \"reg_alpha\": 2.1875, \"reg_lambda\": 0.4166666666666667, \"subsample\": 0.7, \"tree_method\": \"auto\"}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"97d25998e55d7dee34ab7a2a6dd80263b3010f8e\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ SparseNormalizer, XGBoostRegressor }\"}" # PLACEHOLDER
pipeline_id = "97d25998e55d7dee34ab7a2a6dd80263b3010f8e" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"92986d2f-eeae-4f46-b541-458200de3c32\"}}" # PLACEHOLDER
